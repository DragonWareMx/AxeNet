...
import { Breadcrumbs, Button, Card, CardContent, Grid, InputLabel, MenuItem, Select, TextField, Typography } from '@mui/material';
                    ...
                    <CardContent style={{paddingTop:35}}>
                        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
                            ...
                            <Grid container justifyContent={'center'} style={{marginTop:15}}>
                                ...
                                <TextField 
                                    id='information'
                                    label='Proporciona toda la información necesaria para su solución'
                            ...
                            <Grid container justifyContent={'space-between'} marginTop={4}>
                                <Button type='button' variant={'outlined'}>
                                    <Typography variant={'body2'}>Adjuntar archivo</Typography>
                                </Button>
...
TCPForm.layout = page => <Layout children={page} title="TCP" />
